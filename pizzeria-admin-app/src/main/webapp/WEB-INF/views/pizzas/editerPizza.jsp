...
<body>
	...
	<form class="form-horizontal" method="post">
		<fieldset>
			...
			<!-- Form Name -->
			<legend>Edition des pizzas</legend>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input id="nom" name="nom" type="text" value="${pizza.nom
						}"
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input id="prix" name="prix" type="text" placeholder="xx.xx"
						value="${pizza.prix}" class=" form-control
						input-md"
						required="">
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input id="urlimage" name="urlImage" type="text" placeholder="URL"
						value="${pizza.urlImage}" class=" form-control
						input-md"
						required="">
				...
				<div class="col-md-4">
					<select id="categorie" name="categorie" class="form-control">
						<c:forEach var="c" items="${categories}">
							<option <c:if test="${pizza.categorie.equals(c)}">selected</c:if>
								value="${c}">${c.libelle}</option>
						</c:forEach>
					</select>
				</div>
			</div>
